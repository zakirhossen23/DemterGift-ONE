        ...
        try {
            if (contract && id) {
                ...
                for (let i = 0; i < Number(10); i++) {
                    ...
                    if (object.title) {
                        var pricedes1 = 0;
                        try { pricedes1 = formatter.format(Number(object.properties.price.description * 0.1534)) } catch (ex) { }
                        ...
                        <div style={{ width: "100%" }}>
                            ...
                            <div className='ElementBottomContainer'>
                                <div style={{ width: "116px" }}>
                                    ...
                                    <h4 className='bidprice'>$ {listItem.Bidprice} ({listItem.price} ONE)</h4>
